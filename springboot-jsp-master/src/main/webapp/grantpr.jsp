...
<div class="w3-content" style="max-width: 2000px; margin-top: 46px">
		...
		<!-- <div class="w3-container w3-content w3-center w3-padding-64"
			...
			<h2 class="w3-wide">ROLES - PERMISSION</h2>
			<br><br>
			 <div class="userList">
			 User: <select>
			...
			<legend>Role</legend>
			  ...
			  <tr>
			      <td><label for="grantView>">View tables</label></td>
			      <td> <input type="checkbox" id="grantView" value="grantView"/></td>
			  </tr>
			  <tr>
			      <td><label for="grantView>">Inset</label></td>
			      <td><input type="checkbox" id="grantInsert" value="grantInsert"/></td>
			  </tr>
			  
			  <tr>
			      <td><label for="grantView>">Update</label></td>
			      <td> <input type="checkbox" id="grantUpdate" value="grantUpdate"/></td>
			  </tr>
			  
			  <tr>
			      <td><label for="grantView>">Connection</label></td>
			      <td><input type="checkbox" id="grantConnection" value="grantConnection"/></td>
			  </tr>
			  </table>
			  
			  			<input class="button" type="submit" value="Grant">
